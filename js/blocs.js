	...
	$(document).on('click', '[data-lightbox]', function(e) // Create Lightbox Modal
			{
				e.preventDefault();
				targetLightbox = $(this);
				var captionTitle ='<h3 class="lightbox-title">'+$(this).attr('data-title')+'</h3>';
				var captionData ='<p class="lightbox-caption">'+$(this).attr('data-caption')+'</p>';
				if(!$(this).attr('data-title')) // No caption caption data
				{
					captionTitle = '';
				}
	...
	$(document).on('click', '.next-lightbox, .prev-lightbox', function(e) 
			{
				...
				$('.lightbox-title').html(next.attr('data-title'));
